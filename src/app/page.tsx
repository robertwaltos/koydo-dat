...
export const metadata: Metadata = {
  title: "Koydo DAT — Free Exam Prep",
  description: "Comprehensive DAT preparation. Practice tests, AI tutor, score tracking. This app is an independent study aid and is not affiliated with, endorsed by, or approved by DAT or any official testing authority. All trademarks belong to their respective owners.",
};
    ...
    <main className="min-h-screen">
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-[var(--accent)] to-[var(--accent-dark)] px-4 py-20 text-white">
        <div className="mx-auto max-w-4xl text-center">
          <span className="mb-4 inline-block rounded-full bg-white/20 px-4 py-1.5 text-sm font-medium backdrop-blur">
            Tier 8 · smaller annual test takers
          </span>
      ...
      <section className="mx-auto max-w-5xl px-4 py-16">
        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {[
            { icon: "📝", title: "Practice Tests", desc: "Hundreds of practice questions matching the real DAT format." },
      ...
      <footer className="border-t border-zinc-200 dark:border-zinc-800 px-4 py-8">
        <p className="mx-auto max-w-3xl text-center text-xs text-zinc-500 dark:text-zinc-500">
          This app is an independent study aid and is not affiliated with, endorsed by, or approved by DAT or any official testing authority. All trademarks belong to their respective owners.
        </p>
