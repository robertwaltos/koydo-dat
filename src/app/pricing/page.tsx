...
export const metadata: Metadata = {
  title: "Pricing — Dat Premium",
  description: "Unlock unlimited Dat practice with Koydo Premium.",
};

export default function PricingPage() {
  const checkoutUrl = `https://koydo.app/pricing?exam=dat&cadence=annual`;
