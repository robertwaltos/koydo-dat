// Auto-generated shim — re-exports from @/lib/dat/config
// This lets shared ecosystem components import from "@/lib/act/config"
import type { ExamConfig as _dat_Config } from "@/lib/dat/config";
import { EXAM_CONFIG as _raw } from "@/lib/dat/config";
